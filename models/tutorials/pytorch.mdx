...
[PyTorch](https://pytorch.org/) is an open-source deep learning framwork known for its ease of use and Python compatibility. This tutorial shows you how to load data, define a model, and integrate your PyTorch code with W&B to add experiment tracking to your pipeline.
...
As an example, feel free to use the following standard ConvNet architecture:
